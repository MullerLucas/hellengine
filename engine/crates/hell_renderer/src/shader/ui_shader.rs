...
#[repr(C)]
pub struct UiShaderGlobalUniformObject {
...
impl UiShaderGlobalUniformObject {
...
impl Default for UiShaderSceneData {
    fn default() -> Self {
        Self {
